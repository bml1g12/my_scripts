...
for dirname in int_dir_list:
	...
	shutil.copy(current_folder_path+'/'+current_folder_name+'/'+data, data_folder_path+'/'+current_folder_name) #populate it with just the .onetep files
...
print("Writing a csv with forces and energy")
...
plot1=ax1.plot(x_axis, energy_eV_y, '-gx', label="Energy (eV)")
